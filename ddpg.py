...
class DDPG(object):
    ...
    def _build_a(self, s, scope, trainable):
        with tf.compat.v1.variable_scope(scope):
            net = tf.keras.layers.Dense(150, activation=tf.nn.relu, name='l1', trainable=trainable)(s)
            a = tf.keras.layers.Dense(self.a_dim, activation=tf.nn.tanh, name='a', trainable=trainable)(net)
    ...
    def _build_c(self, s, a, scope, trainable):
        with tf.compat.v1.variable_scope(scope):
            ...
            return tf.keras.layers.Dense(1, trainable=trainable)(net)  # Q(s,a)
